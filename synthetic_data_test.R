library(quadprog)
# Simple syntethic example of the Quadratic Programming solution for non-negative constraints
...
# Set some "base forecasts" for bottom-level
B_r1 = 100
D_r1 = 50
G_r1 = 10
...
dvec = t(S) %*% ginv(W) %*% y_base # H matrix and dvec are the matrix and vector for the QP, respectively
